/**
  * v1.0.109 generated on: Tue Jul 26 2016 19:06:25 GMT+0000 (UTC)
...
var Store = function (_NGN$EventEmitter2) {
  ...
  function Store(cfg) {
    ...
    var events = ['record.duplicate', 'record.create', 'record.update', 'record.delete', 'record.restored', 'record.purged', 'clear', 'filter.create', 'filter.delete', 'index.create', 'index.delete'];
